...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./../node_modules/sass-loader/index.js!./code-pen.scss", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/postcss-loader/index.js!./../node_modules/sass-loader/index.js!./code-pen.scss");
	...
	var emailVue = new vue({
	  ...
	  methods: {
	    sendEmail: function sendEmail() {
	      ...
	      axios.post('/api/email', { email: emailVue.emailText }).then(function (res) {
	        return emailVue.submitText = 'Thank You!';
	      }).catch(function (err) {
	        localStorage.removeItem('sentEmail');
	        if (err.status === 404) emailVue.error = 'Server couldn\'t be reached';else emailVue.error = 'Something went wrong';
	      });
	    }
	  }
	});
	  ...
	  return new Promise(function executor(resolve, reject) {
	    try {
	      ...
	      if (typeof config.adapter === 'function') {
	        ...
	        adapter = __webpack_require__(307);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var btoa = window.btoa || __webpack_require__(312);
